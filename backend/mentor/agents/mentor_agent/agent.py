...
class MentorAgent:
    ...
    def run(self,problem_name,analyze,code,question):
        user_promt = MENTOR_USER_PROMPT.format(problem_name=problem_name,analyze=analyze,code=code,question=question)
