...
Return exactly one route: "code_analyzer" or "teaching".

Route to "teaching" when the user asks to learn, be taught, or understand the concept behind the extracted problem.
Route to "code_analyzer" when the user wants help with code, debugging, hints, approach, complexity, or solution guidance.

If unsure, route to "code_analyzer".
"""
